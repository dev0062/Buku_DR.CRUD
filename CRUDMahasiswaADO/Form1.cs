    ...
    public partial class Form1 : Form
    {
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dataGridView1.Columns.Add("KodeProdi", "Kode rodi");
        ...
        private void btnInsert_Click_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = @"INSERT INTO Mahasiswa 
                                (NIM, Nama, JenisKelamin, TanggalLahir, Alamat, KodeProdi, TanggalDaftar) VALUES (@NIM, @Nama, @JK, @TanggalLahir, @Alamat, @KodeProdi, @TanggalDaftar)";
                SqlCommand cmd = new SqlCommand(query, conn);
